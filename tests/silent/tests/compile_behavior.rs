...
#[test]
fn test_fails_silently() {
	let t = trybuild::TestCases::new();
	t.pass("tests/ui/fail-silently/*.rs");
}
...
fn test_missing_source_fails() {
	let t = trybuild::TestCases::new();
	t.pass("tests/ui/fail-silently/missing_source.rs");
}

#[test]
fn test_invalid_attribute_fails() {
	let t = trybuild::TestCases::new();
	t.pass("tests/ui/fail-silently/invalid_attribute.rs");
}

#[test]
fn test_wrong_target_fails() {
	let t = trybuild::TestCases::new();
	t.pass("tests/ui/fail-silently/wrong_target.rs");
}
...
fn test_changed_content_error_fails() {
	let t = trybuild::TestCases::new();
	t.pass("tests/ui/fail-silently/changed_content_error.rs");
}
...
fn test_local_override_ignored() {
	let t = trybuild::TestCases::new();
	t.pass("tests/ui/fail-silently/local_override_ignored.rs");
}

#[test]
fn test_missing_reason_fails() {
	let t = trybuild::TestCases::new();
	t.pass("tests/ui/fail-silently/missing_reason.rs");
}
